...
export declare class JobDbRepository {
    ...
    batchGetNextJobsToRun(jobName: string, batchSize: number, nextScanAt: Date, lockDeadline: Date, now?: Date): Promise<IJobParameters[]>;
     ...
     */
    getConnectionPoolStatus(): Promise<IConnectionPoolStatus | null>;
}
